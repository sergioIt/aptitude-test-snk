...
Пожалуйста, укажите причину Вашего
отказа участвовать в конкурсе на место сварщика термитной сварки
    (необязательно)
</h2>
</div>
...
<?=Html::textarea('reasonDeny','',['id'=>'reason_deny', 'class'=>'form-control','rows'=>4]); ?>
</div>
        </div>
        <div class="row">
        <div class="form-group">
            <?=  Html::button('Отрпавить',['id'=>'btn_send_reason', 'class' => 'btn btn-lg btn-success']); ?>
           </div>
        </div>
    <?= Html::endForm() ?>
<?} ?>